                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatable-responsive"
                                            ...
                                            <tbody>
                                                @foreach ($listsubCategorys as $SubCat)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{route('sub_category.cap-nhat',['id'=>$SubCat->id])}}" class="btn btn-warning">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        </a>
                                                        <a href="{{route('sub_category.xoa',['id'=>$SubCat->id])}}" class="btn btn-danger">
